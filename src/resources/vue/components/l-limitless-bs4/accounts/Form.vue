                    ...
                    <form v-if="!this.$root.loading"
                        ...
                        <fieldset class="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <p>Enter Bank account details e.g;</p>
                                    <small>Account name, account number e.t.c</small>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <model-list-select :list="globalsCountries"
                                                       v-model="attributes.country_code"
                                                       @input="fetchBanks"
                                                       option-value="value"
                                                       option-text="text"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" v-model="attributes.number" value="" class="form-control " placeholder="Number">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <model-list-select :list="$root.globalsCurrencies"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" v-model="attributes.code" value="" class="form-control " placeholder="Code">
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <button type="submit" class="btn btn-danger font-weight-bold">
                                    <i class="icon-library2 mr-1"></i> Create Bank Account
                                </button>
                            </div>
                        </div>
    ...
    export default {
        data() {
            return {
                ...
                urlPost: null, //by default this value is null to handle a situation of user posting form before it has fully loaded
                attributes: {},
                banks:[]
            }
        },
            ...
            async fetchBanks() {
                ...
                let data = {
                    search: [
                        {
                            column: 'country_code',
                            value: this.attributes.country_code
                        }
                    ]
                }
