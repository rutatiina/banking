            ...
            <table class="table table-hover">
                <thead class="">
                    <tr class="table-active">
                        ...
                        <th scope="col" class="font-weight-bold" nowrap="">Value Date</th>
                        <th scope="col" class="font-weight-bold" nowrap="">Description</th>
                        <th scope="col" class="font-weight-bold" nowrap="">Contact</th>
                        <th scope="col" class="font-weight-bold" nowrap="">Reference</th>
                        <th scope="col" class="font-weight-bold text-right" nowrap>Debit</th>
                        <th scope="col" class="font-weight-bold text-right" nowrap>Credit</th>
                    </tr>
                </thead>
                ...
                <tr v-for="row in tableData.payload.data"
                    ...
                    <td class="cursor-pointer" nowrap >{{row.value_date}}</td>
                    <td class="cursor-pointer">{{row.description}}</td>
                    <td class="cursor-pointer">{{row.contact}}</td>
