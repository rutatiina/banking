<template>
    ...
    <div id="banking_payment_refund" class="card card-flat border-0 shadow-0">

        <div class="card-header bg-light header-elements-inline">
            <h4 class="card-title">Payment Refund</h4>
    ...
    export default {
        ...
        mounted() { //Cash Sales Refunds
            this.fetchAccountTxnAttributes({
                ...
                .then(()=>{
                    this.txnAttributes.name = 'payment-refund'
                })
