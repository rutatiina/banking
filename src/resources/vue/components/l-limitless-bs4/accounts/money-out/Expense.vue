<template>
    ...
    <div id="banking_expense" class="card card-flat border-0 shadow-0">
...
<script>
    ...
    export default {
        ...
        watch: {},
        mounted() {
            this.fetchAccountTxnAttributes({financial_account_code: this.$route.params.id, credit: true, name: 'expense'})
                .then(()=>{
                    this.txnAttributes.name = 'expense'
                })
