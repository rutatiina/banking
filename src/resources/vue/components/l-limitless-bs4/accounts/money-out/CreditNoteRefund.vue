<template>
    ...
    <div id="banking_credit_note_refund" class="card card-flat border-0 shadow-0">

        <div class="card-header bg-light header-elements-inline">
            <h4 class="card-title">Credit Note Refund</h4>
            ...
            <form @submit="bankingTxnStore"
                ...
                <fieldset class="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea v-model="txnAttributes.description" class="form-control" placeholder="Description"></textarea>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        watch: {},
        mounted() {
            this.fetchAccountTxnAttributes({financial_account_code: this.$route.params.id, credit: true, name: 'credit-note-refund'})
                .then(()=>{
                    this.txnAttributes.name = 'credit-note-refund'
                })
