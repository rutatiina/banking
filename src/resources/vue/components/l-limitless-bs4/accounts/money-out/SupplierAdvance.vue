<template>
    ...
    <div id="banking_supplier_advance" class="card card-flat border-0 shadow-0">
            ...
            <form @submit="bankingTxnStore"
                ...
                <fieldset class="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" v-model="txnAttributes.reference" class="form-control input-roundless" placeholder="Reference">
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            .then(()=>{
                this.txnAttributes.name = 'supplier-advance'
            });
