<template>
    ...
    <div id="banking_transfer_to_another_account" class="card card-flat border-0 shadow-0">

        <div class="card-header bg-light header-elements-inline">
            <h4 class="card-title">Transfer To Another Account</h4>
    ...
    export default {
        ...
        mounted() {
            ...
            .then(()=>{
                ...
                this.txnAttributes.name = 'transfer'
            });
        ...
        methods: {
            async fetchReceiptDebitAccounts() {
                ...
                try {
                    ...
                    return await axios.get('/banking/accounts/'+this.$route.params.id+'/transfer-recipients')
                        .then(response => {
