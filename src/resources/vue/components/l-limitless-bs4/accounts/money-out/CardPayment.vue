<template>
    ...
    <div id="banking_card_payment" class="card card-flat border-0 shadow-0">
        ...
        <div class="card-body">
            ...
            <form @submit="bankingTxnStore"
                ...
                <fieldset class="">
                    ...
                    <div class="form-group row" title="Choose Expense Account">
                        <label class="col-lg-3 col-form-label">Expense Account:</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Paid to:</label>
                        <div class="col-lg-9">
...
<script>
    ...
    export default {
        ...
        watch: {},
        mounted() {
            this.fetchAccountTxnAttributes({financial_account_code: this.$route.params.id, credit: true, name: 'card-payment'})
                .then(()=>{
                    this.txnAttributes.name = 'card-payment'
                })
