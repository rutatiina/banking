<template>
    ...
    <div id="banking_owners_contribution" class="card card-flat border-0 shadow-0">

        <div class="card-header bg-light header-elements-inline">
            <h4 class="card-title">Owners Contribution</h4>
            ...
            <form @submit="bankingTxnStore"
                ...
                <fieldset class="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <model-list-select :list="txnAccountsEquity"
                                               v-model="txnAttributes.credit_financial_account_code"
                                               option-value="id"
                                               option-text="name"
                                               @input=""
                                               placeholder="Equity Accounts">
                            </model-list-select>
                        </div>
                    </div>
