<template>
    ...
    <div id="banking_customer_advance" class="card card-flat border-0 shadow-0">

        <div class="card-header bg-light header-elements-inline">
            <h4 class="card-title">Customer Advance</h4>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.txnAttributes.debit = this.account.financial_account_code
            this.txnAttributes.base_currency = this.account.currency
            this.txnAttributes.quote_currency = this.account.currency
            this.txnAttributes.exchange_rate = 1
        },
        methods: {}
    }
</script>
